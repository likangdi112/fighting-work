#-*- codeing = utf-8 -*-
#@Time :2020/6/12 15:51
#@Author : 李康迪
#@File : spider.py
#@Software： PyCharm
#-*- codeing = utf-8 -*-
#@Time :2020/6/12 15:05
#@Author : 李康迪
#@File : test1.py
#@Software： PyCharm
# -*- coding:utf-8 -*-
...
class music:
    ...
    def get_hotcomments(self, url):
        ...
        f = open('hotcomment.txt', 'w', encoding='utf-8')#热点评论
    ...
    def get_allcomments(self, url):
        ...
        f = open('commoncomment.txt', 'w', encoding='utf-8')#普通评论
        present_page = 0
...
mail = music()
mail.get_hotcomments("https://music.163.com/weapi/v1/resource/comments/R_SO_4_1418820831?csrf_token=")
mail.get_allcomments("https://music.163.com/weapi/v1/resource/comments/R_SO_4_1418820831?csrf_token=")
